                ...
                <div className="bg-white rounded-lg shadow-md p-6 lg:h-[75vh] overflow-scroll flex-1">
                    ...
                    <div className="mt-8">
                        ...
                        <p className="text-gray-500 text-sm">
                            {applicantFirstName} is a highly skilled{" "}
                            {(application.jobs as unknown as { title: string }).title} with a passion for building
                            innovative and user-friendly applications. He has extensive experience in full-stack
                            development, with a strong focus on JavaScript, React, and Node.js. {applicantFirstName} is
                            a quick learner, a team player, and always strives to deliver high-quality work.
                        </p>
                    </div>
